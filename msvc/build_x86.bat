...
rem msbuild sc-hsm-pkcs11-pcsc\sc-hsm-pkcs11-pcsc.vcxproj /t:Clean;Rebuild /property:Configuration=Release;Platform=Win32

rem msbuild sc-hsm-pkcs11-pcsc\sc-hsm-pkcs11-pcsc.vcxproj /t:Clean;Rebuild /property:Configuration=Debug;Platform=Win32
...
rem msbuild sc-hsm-minidriver\sc-hsm-minidriver.vcxproj /t:Clean;Rebuild /property:Configuration=Release;Platform=Win32

rem msbuild sc-hsm-minidriver\sc-hsm-minidriver.vcxproj /t:Clean;Rebuild /property:Configuration=Debug;Platform=Win32
